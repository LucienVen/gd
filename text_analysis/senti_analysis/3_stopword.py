...
if __name__ == '__main__':
    ...
    sourceFile = './result/2000_neg_cut.txt'
    targetFile = './result/2000_neg_cut_stopword.txt'
    stopWord(sourceFile,targetFile,stopkey)

    sourceFile = './result/2000_pos_cut.txt'
    targetFile = './result/2000_pos_cut_stopword.txt'
    stopWord(sourceFile,targetFile,stopkey)
